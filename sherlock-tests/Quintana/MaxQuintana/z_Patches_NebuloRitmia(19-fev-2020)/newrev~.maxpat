...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 172.0, 213.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 143.0, 213.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "+~"
				}
...
,
					"patching_rect" : [ 145.0, 288.0, 107.0, 19.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 114.0, 213.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 85.0, 213.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "+~"
				}
...
,
					"patching_rect" : [ 145.0, 259.0, 84.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 16.0, 151.0, 79.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 16.0, 111.0, 80.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 16.0, 60.0, 80.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 131.0, 127.0, 35.0, 19.0 ],
					"style" : "",
					"text" : "$1 20"
				}
...
,
					"patching_rect" : [ 131.0, 100.0, 101.0, 19.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 241.0, 127.0, 35.0, 19.0 ],
					"style" : "",
					"text" : "$1 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 241.0, 100.0, 38.0, 19.0 ],
					"style" : "",
					"text" : "/ 255."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "signal", "bang" ],
					"patching_rect" : [ 131.0, 332.0, 30.0, 19.0 ],
					"style" : "",
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 85.0, 365.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 114.0, 365.0, 27.0, 19.0 ],
					"style" : "",
					"text" : "*~"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 1 ],
					"midpoints" : [ 183.833333, 319.0, 301.0, 319.0, 301.0, 182.0, 160.5, 182.0 ],
					"source" : [ "obj-6", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-8", 1 ],
					"midpoints" : [ 213.166667, 327.0, 264.0, 327.0, 264.0, 198.0, 102.5, 198.0 ],
					"source" : [ "obj-6", 2 ]
				}
