...
for file in os.listdir(args.tei):
    ...
    g.add((livraison_F2_tei_E42_tei_file, crm_ns['P190_has_symbolic_content'], u(f'https://raw.githubusercontent.com/OBVIL/mercure-galant/refs/heads/gh-pages/xml/MG-{livraison_id}.xml')))
    ...
    g.add((livraison_F2_tei_E42_tei_file_forge, crm_ns['P190_has_symbolic_content'], u(f'https://github.com/OBVIL/mercure-galant/blob/gh-pages/xml/MG-{livraison_id}.xml')))
    ...
    for article in div:
        ...
        g.add((article_F3_tei_E42_uri_fichier_tei, crm_ns['P190_has_symbolic_content'], u(f'https://raw.githubusercontent.com/sherlock-iremus/mercure-galant-sources/refs/heads/main/tei/articles/{article_id}.xml')))
        ...
        g.add((article_F3_tei_E42_uri_fichier_tei_forge, crm_ns['P190_has_symbolic_content'], u(f'https://github.com/sherlock-iremus/mercure-galant-sources/blob/main/tei/articles/{article_id}.xml')))
