...
for file in os.listdir(args.tei):
    ...
    livraison_F2_tei_E42_id = iremus_ns[cache_tei.get_uuid(["Collection", "Livraisons", livraison_id, "TEI", "F2_E42_id"], True)]
    ...
    # livraison :: TEI :: F3
    livraison_F3_tei = iremus_ns[cache_tei.get_uuid(["Collection", "Livraisons", livraison_id, "TEI", "F3"], True)]
    ...
    livraison_F3_tei_E42 = iremus_ns[cache_tei.get_uuid(["Collection", "Livraisons", livraison_id, "TEI", "F3_E42"], True)]
    ...
    livraison_F3_tei_E42_id = iremus_ns[cache_tei.get_uuid(["Collection", "Livraisons", livraison_id, "TEI", "F3_E42_id"], True)]
    ...
    for article in div:
        ...
        # article :: TEI :: F3
        article_F3_tei = iremus_ns[cache_tei.get_uuid(["Collection", "Livraisons", livraison_id, "TEI", "Articles", article_id, "F3"], True)]
        ...
        article_F3_tei_E42 = iremus_ns[cache_tei.get_uuid(["Collection", "Livraisons", livraison_id, "TEI", "Articles", article_id, "F3_E42"], True)]
        ...
        article_F3_tei_E42_id = iremus_ns[cache_tei.get_uuid(["Collection", "Livraisons", livraison_id, "TEI", "Articles", article_id, "F2_E42_fragment_url_projet",], True)]
