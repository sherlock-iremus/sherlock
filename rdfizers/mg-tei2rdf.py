...
g.add((F18, crm_ns["P1_is_identified_by"], l("Mercure Galant")))
...
for file in os.listdir(args.tei):
    ...
    g.add((livraison_F1, crm_ns["P1_is_identified_by"], l(livraison_titre)))
    ...
    g.add((livraison_F2_originale, crm_ns["P2_has_type"], iremus_ns["7d7fc017-61ba-4f80-88e1-744f1d00dd60"]))
    g.add((livraison_F2_originale, crm_ns["P2_has_type"], iremus_ns["901c2bb5-549d-47e9-bd91-7a21d7cbe49f"]))
    ...
    # Expression TEI
    livraison_F2_tei = iremus_ns[cache_tei.get_uuid(["Corpus", "Livraisons", livraison_id, "Expression TEI", "F2"], True)]
    ...
    g.add((livraison_F2_tei_E42, RDF.type, crm_ns["E42_Identifier"]))
    g.add((livraison_F2_tei_E42, crm_ns["P2_has_type"], iremus_ns["219fd53d-cdf2-4174-8d71-6d12bdd24016"]))
    g.add((livraison_F2_tei_E42, crm_ns["P190_has_symbolic_content"], u(f"http://data-iremus.huma-num.fr/files/mercure-galant/tei/livraisons/{file[0:-4]}.xml")))

    # Identifiant de la TEI
    livraison_F2_tei_E42_id = iremus_ns[cache_tei.get_uuid(["Corpus", "Livraisons", livraison_id, "Expression TEI", "F2_E42_id"], True)]
    ...
    g.add((livraison_F2_tei_E42_id, crm_ns["P2_has_type"], iremus_ns["92c258a0-1e34-437f-9686-e24322b95305"]))
    g.add((livraison_F2_tei_E42_id, crm_ns["P190_has_symbolic_content"], l(livraison_id)))

    # Creation de l'expression TEI
    livraison_F2_tei_F28 = iremus_ns[cache_tei.get_uuid(["Corpus", "Livraisons", livraison_id, "Expression TEI", "F2_F28"], True)]
    ...
    for article in div:
        ...
        g.add((article_F2_original, crm_ns["P1_is_identified_by"], l(article_titre)))
        ...
        g.add((article_F2_tei, crm_ns["P1_is_identified_by"], article_F2_tei_E42))
        g.add((article_F2_tei_E42, RDF.type, crm_ns["E42_Identifier"]))
        g.add((article_F2_tei_E42, crm_ns["P190_has_symbolic_content"], l(article_id)))
