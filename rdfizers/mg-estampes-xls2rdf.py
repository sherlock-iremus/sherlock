...
print(f"{len(personnes_directus)} personnes")
...
print(f"{len(lieux_directus)} lieux")
...
#             t(estampe, a, crm_ns["E36_Visual_Item"))
#             t(corpus, she_ns("has_member"), estampe)
#             t(estampe, crm_ns["P2_has_type"), estampe_e55_uri)
#             # endregion

#             # region E42: Identifiant Mercure Galant de l'estampe
#             E42_uuid = she(cache.get_uuid(["estampes", id, "E42_mercure_uuid"], True))
#             t(E42_uuid, a, crm_ns["E42_Identifier"))
#             t(E42_uuid, crm_ns["P2_has_type"), identifiant_mercure_e55_uri)
#             t(E42_uuid, crm_ns["P190_has_symbolic_content"), l(id))
#             t(estampe, crm_ns["P1_is_identified_by"), E42_uuid)
#             # endregion

#             # region E42: Identifiant IIIF de l'estampe
#             E42_iiif = she(cache.get_uuid(["estampes", id, "E42_IIIF_humanum_uuid"], True))
#             t(E42_iiif, a, crm_ns["E42_Identifier"))
#             t(E42_iiif, crm_ns["P2_has_type"), identifiant_iiif_e55_uri)
#             t(E42_iiif, crm_ns["P190_has_symbolic_content"), u(f"https://ceres.huma-num.fr/iiif/3/mercure-galant-estampes--{id.replace(' ', '%20')}/full/max/0/default.jpg"))
#             t(estampe, crm_ns["P1_is_identified_by"), E42_iiif)
#             # endregion
...
#                         t(article_F2_original, crm_ns["P148_has_component"), estampe)
#                         t(article_F2_TEI, crm_ns["P148_has_component"), estampe)
#                     except:
...
#                         t(livraison_F2_originale, crm_ns["P148_has_component"), estampe)
#                         t(livraison_F2_TEI, crm_ns["P148_has_component"), estampe)
#                     except:
...
#                             t(e13, crm_ns["P3_has_note"), l(row["Commentaire ID article lié OBVIL"]))
#                     except:
...
#                         t(E42_gallica, RDF.type, crm_ns["E42_Identifier"))
#                         t(E42_gallica, crm_ns["P190_has_symbolic_content"), u(url))
#                         t(E42_gallica, crm_ns["P2_has_type"), lien_gallica_e55_uri)
...
#                     t(estampe, crm_ns["P3_has_note"), l(cell_content))
#             # endregion
...
#                     t(estampe_fragment, a, crm_ns["E36_Visual_Item"))
#                     t(estampe_fragment, crm_ns["P106i_forms_part_of"), estampe)
#                     t(estampe_fragment_e42_iiif, crm_ns["P2_has_type"), identifiant_iiif_e55_uri)
#                     t(estampe_fragment_e42_iiif, RDF.type, crm_ns["E42_Identifier"))
...
#                     make_E13(["estampes", id, "lieux représentés", lieu, "E36_fragment", "E13_P138_uuid"], estampe_fragment, crm_ns["P138_represents"), she(lieu), estampe)
#                     lieux_used.append(lieu)
#             # endregion
...
#                     t(estampe_fragment, crm_ns["P106i_forms_part_of"), estampe)
#                     t(estampe_fragment_e42_iiif, crm_ns["P2_has_type"), identifiant_iiif_e55_uri)
#                     t(estampe_fragment_e42_iiif, a, crm_ns["E42_Identifier"))
#                     t(e18_objet, a, crm_ns["E18_Physical_Thing"))
#                     t(e18_objet, crm_ns["P2_has_type"), objet_type_uri)
...
#                             t(estampe_fragment_avers, a, crm_ns["E36_Visual_Item"))
#                             t(estampe_fragment_avers, crm_ns["P106i_forms_part_of"), estampe_fragment)
#                             t(e18_avers, a, crm_ns["E18_Physical_Thing"))
#                             t(e18_avers, crm_ns["P2_has_type"), avers_medaille_e55_uri)
#                             t(estampe_fragment_avers_e42_iiif, crm_ns["P2_has_type"), identifiant_iiif_e55_uri)
#                             t(estampe_fragment_avers_e42_iiif, a, crm_ns["E42_Identifier"))
#                             t(e34_inscription, a, crm_ns["E34_Inscription"))
#                             t(e34_inscription, a, crm_ns["E33_Linguistic_Object"))
...
#                             make_E13(["estampes", id, "objets", objet, "E36_fragment", "médaille_avers", "inscription", "E13_uuid"], e34_inscription, crm_ns["P190_has_symbolic_content"), l(row["Médailles: avers"]), estampe)
...
#                             t(estampe_fragment_revers, a, crm_ns["E36_Visual_Item"))
#                             t(estampe_fragment_revers, crm_ns["P106i_forms_part_of"), estampe_fragment)
#                             t(e18_revers, a, crm_ns["E18_Physical_Thing"))
#                             t(e18_revers, crm_ns["P2_has_type"), revers_medaille_e55_uri)
#                             t(estampe_fragment_revers_e42_iiif, crm_ns["P2_has_type"), identifiant_iiif_e55_uri)
#                             t(estampe_fragment_revers_e42_iiif, a, crm_ns["E42_Identifier"))
#                             t(e34_inscription, a, crm_ns["E34_Inscription"))
#                             t(e34_inscription, a, crm_ns["E33_Linguistic_Object"))
...
#                             make_E13(["estampes", id, "objets", objet, "E36_fragment", "médaille_revers", "inscription", "E13_uuid"], e34_inscription, crm_ns["P190_has_symbolic_content"), l(row["Médailles: revers"]), estampe)
#             # endregion
...
#                 t(estampe_E65, a, crm_ns["E65_Creation"))
#                 t(estampe_E65, crm_ns["P94_has_created"), estampe)
#             # endregion
...
#                 t(estampe_invenit, a, crm_ns["E65_Creation"))
#                 t(estampe_invenit, crm_ns["P2_has_type"), invenit_e55_uri)
#                 t(estampe_E65, crm_ns["P9_consists_of"), estampe_invenit)
...
#                 make_E13(["estampes", id, "E65", "E65_invenit", "E13_P14_uuid"], estampe_invenit, crm_ns["P14_carried_out_by"), she(concepteur_uuid), estampe)
#             # endregion
...
#                 t(estampe_sculpsit, a, crm_ns["E65_Creation"))
#                 t(estampe_sculpsit, crm_ns["P2_has_type"), sculpsit_e55_uri)
#                 t(estampe_E65, crm_ns["P9_consists_of"), estampe_sculpsit)

#                 # Lien entre la gravure de l'estampe et son graveur (E13)
#                 graveur_uuid = row["Graveur ['Sculpsit' ou 'Incidit' ou 'fecit']"].strip().lower()
#                 make_E13(["estampes", id, "E65", "E65_sculpsit", "E13_P14_uuid"], estampe_sculpsit, crm_ns["P14_carried_out_by"), she(graveur_uuid), estampe)
#             # endregion
...
#             t(livraison_F5_consultation, crm_ns["P46_is_composed_of"), E24_feuille)
#             t(E24_feuille, crm_ns["P46i_forms_part_of"), livraison_F5_consultation)
#             t(E24_feuille, crm_ns["P65_shows_visual_item"), estampe)
...
#                 t(E42_provenance, a, crm_ns["E42_Identifier"))
#                 t(E42_provenance, crm_ns["P2_has_type"), cote_bnf_e55_uri)
#                 t(E42_provenance, crm_ns["P190_has_symbolic_content"), l(row["Provenance cliché"]))
#                 t(livraison_F5_consultation, crm_ns["P1_is_identified_by"), E42_provenance)
...
#                 t(hauteur_uri, a, crm_ns["E54_Dimension"))
#                 t(hauteur_uri, crm_ns["P2_has_type"), u("http://vocab.getty.edu/page/aat/300055644"))
#                 t(hauteur_uri, crm_ns["P90_has_value"), l(format[0].strip().replace("’", "'")))
#                 t(hauteur_uri, crm_ns["P91_has_unit"), u("http://vocab.getty.edu/page/aat/300379098"))
...
#                 t(largeur_uri, a, crm_ns["E54_Dimension"))
#                 t(largeur_uri, crm_ns["P2_has_type"), u("http://vocab.getty.edu/page/aat/300055647"))
#                 t(largeur_uri, crm_ns["P90_has_value"), l(format[1].replace("cm", "").strip().replace("’", "'")))
#                 t(largeur_uri, crm_ns["P91_has_unit"), u("http://vocab.getty.edu/page/aat/300379098"))
