...
# USAGE : python3 sources-processors/images/mirror_collection_to_nakala.py --pictures=../in/mercure-galant-sources/pictures --collection=10.34847/nkl.d1dffz6h --cache=caches/mg/estampes_nakala_mirror.yaml
############################################################################################
