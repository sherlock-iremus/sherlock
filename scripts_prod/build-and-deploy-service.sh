...
MICRONAUT_ENVIRONMENTS=prod ./gradlew dockerBuild
...
ssh tbottini@data-iremus.huma-num.fr "cd /home/tbottini/sherlock/ ; sudo -S docker-compose up -d --build --remove-orphans sherlock"